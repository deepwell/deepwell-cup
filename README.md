...
- **Conference / Cup preseason picks:** `2^(R − 1)` when the picked team’s deepest playoff round **R** is greater than 1, else `0`. A correct Stanley Cup champion pick scores **16** (`2^4`), not the round‑4 depth cap of 8.
